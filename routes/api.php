...
Route::middleware('auth.api_token')->group(function () {
    ...
    Route::get('/user/payout-accounts', [UserPayoutAccountController::class, 'index']);
    Route::post('/user/payout-accounts', [UserPayoutAccountController::class, 'store']);
    Route::put('/user/payout-accounts/{payoutAccount}', [UserPayoutAccountController::class, 'update']);
    ...
    Route::post('/trips/{trip}/paypal-order', [PayPalOrderController::class, 'forTrip']);
